...
class BikeFitManager:
    def __init__(self, filename=None):
        # Default to data directory from the new structure
        if filename is None:
            # Get the path to the data directory from this file's location
            current_dir = os.path.dirname(os.path.dirname(os.path.dirname(__file__)))
            filename = os.path.join(current_dir, "data", "bike_fit_data.csv")
